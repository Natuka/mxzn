<template>
  <div>
    ...
    <mx-repair-action-item class="mx-sign-up"></mx-repair-action-item>
  </div>
</template>
...
import mxRepairActionItem from "../common/mx-repair-action-item";
import {
  ORDER_TYPE,
  ORDER_STATUS,
  ORDER_DEGREE,
...
export default {
  name: "mx-action-list",
  components: {
    [mxRepairActionItem.name]: mxRepairActionItem
  },
  data() {
    return {
