...
class CreateServiceEquipmentFaultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_equipment_faults', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('service_order_id')->default(0)->comment('工单id');
            ...
            $table->string('code',50)->default('')->comment('故障代码');
            ...
            $table->string('image_ids',50)->nullable()->comment('故障照片');
            $table->string('attach_ids',50)->nullable()->comment('故障附件资料');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('service_equipment_faults');
    }
}
