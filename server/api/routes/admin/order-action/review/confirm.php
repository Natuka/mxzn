 ...
 */
Route::group([
    'prefix' => 'order_flow/review/{order}/confirm',
    'namespace' => 'Admin\OrderFlow\Action'
], function () {
    Route::get('default', [
        'uses' => 'ConfirmController@default',
        'as' => 'order_review_confirm_default',
        'display_name' => '工单维护-客户确认',
        'visible' => true,
        'alias' => 'order_review_confirm_list',
    ]);
    Route::get('/', [
        'uses' => 'ConfirmController@index',
        'as' => 'order_review_confirm_list',
        'display_name' => '客户确认列表',
        'visible' => true,
    ]);
    ...
    Route::post('/', [
        ...
        'as' => 'order_review_confirm_create',
        'display_name' => '客户确认新增',
        'visible' => false,
    ]);
    ...
    Route::put('/{confirm}', [
        ...
        'as' => 'order_review_confirm_update',
        'display_name' => '客户确认修改',
        'visible' => false,
    ]);
    ...
    Route::delete('/{confirm}', [
        ...
        'as' => 'order_review_confirm_delete',
        'display_name' => '客户确认删除',
        'visible' => false,
    ]);
