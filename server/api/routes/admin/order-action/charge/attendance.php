 ...
 */
Route::group([
    'prefix' => 'order_flow/charge/{order}/attendance',
    'namespace' => 'Admin\OrderFlow\Action'
], function () {
    Route::get('default', [
        'uses' => 'AttendanceController@default',
        'as' => 'order_charge_attendance_default',
        'display_name' => '工单维护-签到记录',
        'visible' => true,
        'alias' => 'order_charge_attendance_list',
    ]);
    Route::get('/', [
        'uses' => 'AttendanceController@index',
        'as' => 'order_charge_attendance_list',
        'display_name' => '签到记录列表',
        'visible' => true,
    ]);
    ...
    Route::post('/', [
        ...
        'as' => 'order_charge_attendance_create',
        'display_name' => '签到记录新增',
        'visible' => false,
    ]);
    ...
    Route::put('/{attendance}', [
        ...
        'as' => 'order_charge_attendance_update',
        'display_name' => '签到记录修改',
        'visible' => false,
    ]);
    ...
    Route::delete('/{attendance}', [
        ...
        'as' => 'order_charge_attendance_delete',
        'display_name' => '签到记录删除',
        'visible' => false,
    ]);
