 ...
 */
Route::group([
    'prefix' => 'order_flow/close/{order}/confirm',
    'namespace' => 'Admin\OrderFlow\Action'
], function () {
    Route::get('default', [
        'uses' => 'ConfirmController@default',
        'as' => 'order_close_confirm_default',
        'display_name' => '工单维护-客户确认',
        'visible' => true,
        'alias' => 'order_close_confirm_list',
    ]);
    Route::get('/', [
        'uses' => 'ConfirmController@index',
        'as' => 'order_close_confirm_list',
        'display_name' => '客户确认列表',
        'visible' => true,
    ]);
