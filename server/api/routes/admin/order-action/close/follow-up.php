 ...
 */
Route::group([
    'prefix' => 'order_flow/close/{order}/follow-up',
    'namespace' => 'Admin\OrderFlow\Action'
], function () {
    Route::get('default', [
        'uses' => 'FollowupController@default',
        'as' => 'order_close_followup_default',
        'display_name' => '工单维护-签到记录',
        'visible' => true,
        'alias' => 'order_close_followup_list',
    ]);
    Route::get('/', [
        'uses' => 'FollowupController@index',
        'as' => 'order_close_followup_list',
        'display_name' => '签到记录列表',
        'visible' => true,
    ]);
    ...
    Route::post('/', [
        ...
        'as' => 'order_close_followup_create',
        'display_name' => '签到记录新增',
        'visible' => false,
    ]);
    ...
    Route::put('/{followup}', [
        ...
        'as' => 'order_close_followup_update',
        'display_name' => '签到记录修改',
        'visible' => false,
    ]);
    ...
    Route::delete('/{followup}', [
        ...
        'as' => 'order_close_followup_delete',
        'display_name' => '签到记录删除',
        'visible' => false,
    ]);
