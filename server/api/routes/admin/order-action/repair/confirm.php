...
Route::group([
    ...
    Route::post('/', [
        ...
        'as' => 'order_repair_confirm_create',
        'display_name' => '客户确认新增',
        'visible' => false,
    ]);
    ...
    Route::put('/{confirm}', [
        ...
        'as' => 'order_repair_confirm_update',
        'display_name' => '客户确认修改',
        'visible' => false,
    ]);
    ...
    Route::delete('/{confirm}', [
        ...
        'as' => 'order_repair_confirm_delete',
        'display_name' => '客户确认删除',
        'visible' => false,
    ]);
