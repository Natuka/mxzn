<template>
  <div>
    ...
    <dispatch-add ref="add" @refresh="refresh"></dispatch-add>
    <dispatch-edit ref="edit" @refresh="refreshWithPage"></dispatch-edit>
...
import {dispatchBack} from '@/api/order_flow/dispatch'
import {dispatchNext} from '@/api/order_flow/dispatch'
