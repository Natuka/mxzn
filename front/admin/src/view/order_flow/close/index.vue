<template>
  <div>
    <Card>
      ...
      <close-search ref="search" @on-search="onSearch"></close-search>
      <tables
        ref="tables"
        :loading="loading"
        editable
    ...
    <close-add ref="add" @refresh="refresh"></close-add>
    <close-edit ref="edit" @refresh="refreshWithPage"></close-edit>
...
import {closeBack} from '@/api/order_flow/close'
import {closeNext} from '@/api/order_flow/close'
