<template>
  <div>
    <Card>
      ...
      <maintain-search ref="search" @on-search="onSearch"></maintain-search>
      <tables
        ref="tables"
        :loading="loading"
        editable
    ...
    <maintain-add ref="add" @refresh="refresh"></maintain-add>
    <maintain-edit ref="edit" @refresh="refreshWithPage"></maintain-edit>
...
import {maintainNext} from '@/api/order_flow/maintain'
